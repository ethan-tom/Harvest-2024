...
#     intersect = waypointBase(phi3, lambda3)
#     return delta12, theta12, theta21, alpha1, alpha2, alpha3, delta13, intersect
...
class PathBase:
    def __init__(self, pointA, pointB):
        ...
        self.counter = 10
        self.bearing, self.distance = line_constructor(pointA,pointB)
